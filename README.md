...
```
dotnet publish "../Framework" --configuration Release --framework net7.0
dotnet publish --configuration Release --framework net7.0 --output "%Project%/Managed/Tests"
```
